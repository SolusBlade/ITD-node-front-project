...
export const Header = () => {
  ...
  const selectHandler = () => {
    ...
    root.style.setProperty(
      '--primary-background',
      themes[selectValue].primaryBackground
    );
    root.style.setProperty(
      '--secondary-background',
      themes[selectValue].secondaryBackground
    );
    root.style.setProperty(
      '--header-background',
      themes[selectValue].headerBackground
    );
    root.style.setProperty(
      '--primary-text-color',
      themes[selectValue].primaryTextColor
    );
    root.style.setProperty(
      '--secondary-text-color',
      themes[selectValue].secondaryTextColor
    );
    ...
    root.style.setProperty(
      '--btn-text-color',
      themes[selectValue].btnTextColor
    );
